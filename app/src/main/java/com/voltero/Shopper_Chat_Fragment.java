...
public class Shopper_Chat_Fragment extends Fragment {
    ...
    public void onResume() {
        ...
        HomeShopper.adapter.notifyDataSetChanged();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        messageList.setAdapter(HomeShopper.adapter);
        ...
        send.setOnClickListener(v -> {
            ...
            if (!message.isEmpty()) {
                ...
                try {
                    ...
                    HomeShopper.adapter.addItem(json);
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                urlBuilder.addQueryParameter("user_email", HomeShopper.session_email);
